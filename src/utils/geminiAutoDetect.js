 ...
 */
import { createWatermarkEngine, calculateWatermarkPosition, detectWatermarkConfig, removeWatermarkFromImage, removeRepeatedWatermarkLayers } from 'https://esm.sh/@pilio/gemini-watermark-remover@1.0.41'

export { createWatermarkEngine, calculateWatermarkPosition, detectWatermarkConfig, removeWatermarkFromImage, removeRepeatedWatermarkLayers }

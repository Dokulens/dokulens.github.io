...
export function calculateWatermarkPosition(imgWidth, imgHeight) {
  // Gemini image watermark: 48px or 96px, specific margins per GargantuaX catalog
  // 0.5K: 48x48, margin 32; 1K+: 96x96, margin 64
  // For video: separate catalog in WatermarkRemover.jsx
